...
{
    public class ServiceBase<T>(IRepositoryBase<T> repository) : IServiceBase<T> where T : EntityBase
    {
        ...
        public async Task<T?> GetByIdNoTrackingAsync(int id) => await _repository.GetByIdAsync(id);
